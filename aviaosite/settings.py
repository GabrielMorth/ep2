"""
Django settings for aviaosite project.
...
SECRET_KEY = 'django-insecure-5=%@281%rkmb-f#%hmj5zy=e-ouj+m^5)e#@6%pix-0mmizz=0'
...
WSGI_APPLICATION = 'aviaosite.wsgi.application'
